...
import NavLogo from '../public/assets/SC.png'
...
const Navbar = () => {
  ...
  const [navBg, setNavBg] = useState('#171818');
  const [navB, setNavB] = useState('#1f2937');
  ...
  //     setLinkColor('#ecf0f3');
  //   } else {
  //     // Apply light mode styles when darkMode is false
  //     setNavBg('#ecf0f3');
  //     setLinkColor('#1f2937');
  //   }
  // }, [darkMode]);
...
// }
  ...
  return (
    ...
    <div
        style={{ backgroundColor: `${theme === 'dark' ? navB : navBg}`, color:'#ecf0f3'  }}
      ...
      >
        ...
        >
          ...
          <div className='py-4 flex flex-col'>
            ...
            <div className='pt-40'>
              <p className='uppercase tracking-widest text-[#39a5ab]'>
                Let&#39;s Connect
              </p>
